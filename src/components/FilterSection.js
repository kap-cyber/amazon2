          ...
          
          {
            colorsData.map((curColor,index)=>{
              if(curColor==="all"){
                ...
                value={curColor} 
                name="colors" className="color-all--style" key={index}
                onClick={updateFilterValue}
                >
                  all
                  </button>
                ...
                return ( <button type="button"
                value={curColor} 
                name="colors"style={{backgroundColor:curColor}}className={colors === curColor ? "btnStyle active" : "btnStyle"} key={index}
                onClick={updateFilterValue}
                >
